...
Error_all_los_ch2 = [];
for i = 1:7
    Hex_path = strcat('I:\Data_set\Technical_validation\Range_error\Outdoor_Range_error\outdoor_LOS_CH2\',num2str(i),'\');
    D = dir([Hex_path,'*.mat']);
    for j = 1:10
...
title('Los Ranging Error [m]:Outdoor-CH2');
...
Error_all_los_ch3 = [];
for i = 1:7
    Hex_path = strcat('I:\Data_set\Technical_validation\Range_error\Outdoor_Range_error\outdoor_LOS_CH3\',num2str(i),'\');
    D = dir([Hex_path,'*.mat']);
    for j = 1:10
        data_hex = load([Hex_path,D(j).name]);
...
title('Los Ranging Error [m]:Outdoor-CH3');
xlabel('Ranging error [m]');
ylabel('Probability');
legend('CH3');
grid on
...
Error_all_los_ch4 = [];
for i = 1:7
    Hex_path = strcat('I:\Data_set\Technical_validation\Range_error\Outdoor_Range_error\outdoor_LOS_CH4\',num2str(i),'\');
    D = dir([Hex_path,'*.mat']);
    for j = 1:10
        data_hex = load([Hex_path,D(j).name]);
...
title('Los Ranging Error [m]:Outdoor-CH4');
xlabel('Ranging error [m]');
ylabel('Probability');
legend('CH4');
grid on
...
Error_all_los_ch5 = [];
for i = 1:7
    Hex_path = strcat('I:\Data_set\Technical_validation\Range_error\Outdoor_Range_error\outdoor_LOS_CH5\',num2str(i),'\');
    D = dir([Hex_path,'*.mat']);
    for j = 1:10
        data_hex = load([Hex_path,D(j).name]);
...
title('Los Ranging Error [m]:Outdoor-CH5');
xlabel('Ranging error [m]');
ylabel('Probability');
legend('CH5');
grid on
...
title('LOS Ranging Error [m]:Outdoor');
xlabel('Ranging Error [m]');
ylabel('Probability');
xlim([-0.5 5.5]);
ylim([0 0.1]);
